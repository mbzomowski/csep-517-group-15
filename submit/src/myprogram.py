...
class MyModel:
    ...
    def run_pred(self, data):
        ...
        # Look for model files primarily in the work directory
        possible_meta_paths = [
            "/job/work/meta.pkl",           # Check work directory (primary location in submission)
            "/job/data/flores/meta.pkl",    # Check mounted volume 
            "/job/meta.pkl",                # Check root directory
            "../work/meta.pkl",             # Check relative path from src dir
            "work/meta.pkl"                 # Check relative path
        ]
        ...
        possible_ckpt_paths = [
            "/job/work/ckpt.pt",            # Check work directory (primary location in submission)
            "/job/out-flores-eng/ckpt.pt",  # Check Docker path
            "/job/ckpt.pt",                 # Check root directory
            "../work/ckpt.pt",              # Check relative path from src dir
            "work/ckpt.pt"                  # Check relative path
        ]
